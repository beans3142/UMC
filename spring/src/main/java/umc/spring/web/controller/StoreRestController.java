...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.StoreResultDTO> createStore(
        ...
        StoreResponseDTO.StoreResultDTO responseDTO = StoreConverter.toStoreResultDTO(savedStore);
    ...
    public ApiResponse<StoreResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistStore @PathVariable(name = "storeId") Long storeId,@Valid @ValidPage @RequestParam(name = "page") Integer page){
