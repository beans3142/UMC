...
public enum ErrorStatus implements BaseErrorCode {
    ...
    INVALID_PASSWORD(HttpStatus.UNAUTHORIZED, "MEMBER4002", "비밀번호가 일치하지 않습니다."),

    // 미션 관련 에러
    MISSION_NOT_FOUND(HttpStatus.BAD_REQUEST, "MISSION4001", "미션이 없습니다."),

    // 푸드 카테고리 관련 에러
    FOOD_CATEGORY_NOT_FOUND(HttpStatus.BAD_REQUEST, "FOOD4001", "음식 카테고리를 찾을 수 없습니다."),
    ...
    // 페이지 관련 에러
    INVALID_PAGE(HttpStatus.BAD_REQUEST, "PAGE4001", "page는 1 이상의 값이어야 합니다."),
